...
# DATA_DIR="/encrypted/SFBData/liz0f/da_graph/dataset_files/TCGA/patch_images_sorted/128x128-19cancers_max_balanced"
...
genomics_table_fp="download/train/train_demo_TCGA/genomics_table.csv"
transcriptomics_table_fp="download/train/train_demo_TCGA/transcriptomics_table.csv"
OPENAI_LOGDIR="./checkpoints/19classes_omics_TCGA_diffusion_newembed-128x128--batch_size_${batch_size}--lr_${lr}--ns_sched_${noise_schedule}"

MODEL_FLAGS="--model_type omics_unet \
    --image_size 128 \
